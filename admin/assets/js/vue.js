...
/***/ function(module, exports, __webpack_require__) {
	...
	function install (Vue) {
	    ...
	    Vue.component('multiselect', __webpack_require__(8));
	    Vue.component('input-tags', __webpack_require__(27));
	    Vue.component('v-modal', __webpack_require__(9));
	    Vue.component('v-pagination', __webpack_require__(10));

	    Vue.directive('datetime', __webpack_require__(11));
	    Vue.directive('confirm', __webpack_require__(12));
	    Vue.directive('spinner', __webpack_require__(13));
	...
	Vue.field.templates.formrow = __webpack_require__(24);
	Vue.field.templates.raw = __webpack_require__(25);
	Vue.field.templates.descriptionlist = __webpack_require__(29);
...
/***/ function(module, exports) {
	...
	var __vue_template__ = "<ul class=\"uk-list bps-selectlist uk-margin-top-remove\">\n        <li v-repeat=\"option: options\" v-class=\"uk-active: selected(option.value)\">\n            <div class=\"uk-panel\">\n                {{{option.text}}}\n                <a v-on=\"click: toggle(option.value)\" class=\"uk-position-cover\"></a>\n            </div>\n        </li>\n    </ul>";
	module.exports = {
	    ...
	    bind: function () {
	        ...
	        this.dirs.forEach(function (dir) {
	            ...
	            _.on(dir.el, dir.arg, function (e) {
	                UIkit.modal.confirm(self.options.text, function () {
	                    dir.handler(e);
	                }, self.options);
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (Vue) {
	    ...
	    var field = __webpack_require__(18)(_, Vue);
	    var validator = __webpack_require__(21)(_);
	    ...
	    Vue.directive('validate', __webpack_require__(23)(_));
	...
	module.exports = function (_, Vue) {
	    ...
	    function Fields(options) {
	        ...
	        return {
	            ...
	            components: {
	                field: __webpack_require__(19)(_, _.extend(options.fields || {}, Fields.types))
	            }
